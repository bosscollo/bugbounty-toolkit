...
from recon_modules import run_full_recon, summarize_text, extract_summary_input
...
if st.button("Run Full Recon") and domain:
    ...
    st.subheader("🧠 AI Summary of Recon Report")
    try:
        summary_input = extract_summary_input(report)
